...
const Footer = () => {
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto 
    items-center justify-center'>
        ...
        <div className='grid'>
          <span className='divTitle font-semibold text-white text-[18px] pb-[1.5rem]'>Company</span>
        ...
        <div className='grid'>
          <span className='divTitle font-semibold text-white text-[18px] pb-[1.5rem]'>Resources</span>
          <div className='grid gap-3 '>
        ...
        <div className='grid'>
          <span className='divTitle font-semibold text-white text-[18px] pb-[1.5rem]'>Support</span>
          <div className='grid gap-3 '>
        ...
        <div className='grid'>
          <span className='divTitle font-semibold text-white text-[18px] pb-[1.5rem]'>Contact Info</span>
          <div>
            <small className='text-[14px] text-white'>
              Blavierkula58@gmail.com
            </small>
